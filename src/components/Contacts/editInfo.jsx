...
// Reusable aesthetic sub-components inherited from addContact.jsx
...
export default function EditContact({ contact, onSave, onCancel }) {
  // Initialize country based on the contact's existing country_code, or default to item 79
  const initialCountry = countryOptions.find((c) => c.c_code === contact?.country_code) || countryOptions[79];
  const [selectedCountry, setSelectedCountry] = useState(initialCountry);
  const [showCountryPicker, setShowCountryPicker] = useState(false);
  const [countrySearch, setCountrySearch] = useState("");
  
  // Initialize situations array handling strings or fallbacks
  ...
  const handleSubmit = (e) => {
    ...
    if (isValid && onSave) {
      onSave({
        ...contact, // Retain properties like id if existing
        ...formData,
  ...
  return (
    <div className="modal-content w-full max-w-lg mx-auto p-4">
      <form onSubmit={handleSubmit}>
        ...
        >
          <h5 style={{ color: "#0F1B3E", fontSize: "20px", fontWeight: 700, marginBottom: "20px" }}>
          ...
          <div style={{ display: "flex", flexDirection: "column", gap: "14px", marginBottom: "24px" }}>
            ...
            <InputField
              label="Relationship (Who are you to them?)"
              name="relation"
              type="text"
          ...
          <div style={{ display: "flex", gap: "12px" }}>
            ...
            <button
              ...
              style={{
                ...
                padding: "14px",
                borderRadius: "16px",
                background: isValid ? "linear-gradient(135deg, #2C5FD4, #5B3FE8)" : "#DDE3F5",
